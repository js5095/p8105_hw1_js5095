...
Here are a summary of their values: `r summary(penguins)`. \
The dataset has `r nrow(penguins)` rows and `r ncol(penguins)` columns. \
The mean of flipper length is `r mean(na.omit(pull(penguins, flipper_length_mm)))` (excluding NA in the dataset).
